      ...
      <div className="bg-white dark:bg-slate-900 border-slate-50 rounded-xl dark:border-slate-800 px-6 py-4 flex flex-col md:flex-row md:items-center justify-between gap-4 shadow-sm z-30">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
          ...
          <div className="flex items-center gap-2 w-full sm:w-auto">
            <Button
              variant="outline"
              className="h-11 px-4 rounded-xl border-slate-200 dark:border-slate-700 text-slate-600 dark:text-slate-300 sm:flex flex-1 sm:flex-none font-medium shadow-sm hover:bg-slate-100 dark:hover:bg-slate-800"
            >
                  ...
                  <td colSpan={8}>
                    <div className="flex flex-col items-center justify-center gap-3 py-24">
                      ...
                      <p className="text-slate-500 text-sm font-medium">
                        We couldn't find any candidate matching "{searchTerm}".
                      </p>
                    </div>
                  </td>
                </tr>
