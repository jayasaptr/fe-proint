...
// Derive the worker URL from the actually installed pdfjs-dist version so the
// worker never drifts from the API version (avoids the
// "API version does not match the Worker version" runtime error).
